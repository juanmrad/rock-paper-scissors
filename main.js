  ...
  return `
        <div class="container d-flex flex-column justify-content-start align-items-center">
            ...
            <div class="w-50 text-center">
                ...
                <button class="btn btn-info" onclick="playGame('PAPER')" id="paper-button">Paper</button>
                <button class="btn btn-secondary" onclick="playGame('SCISSORS')" id="scissors-button">Scissors</button>
            </div>
